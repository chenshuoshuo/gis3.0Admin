<template>
    <div class="app-container attr-organization">
        ...
        <el-table :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit
            ...
            <el-table-column width="100" align="center" :label="$t('table.numer')">
          ...
          <el-dialog
            ...
            <el-form :model="formData" ref="postForm" label-position="right" label-width="100px" class="post-form">
                <el-form-item :label="$t('form.icon')+':'" prop="icon" required>
                  <el-upload
              ...
              <el-form-item :label="$t('form.categoryName')+':'" prop="categoryName" required>
              ...
              <el-form-item :label="$t('form.displayLevel')+':'" required>
                  <el-input v-model="formData.displayLevel"></el-input>
              </el-form-item>
              <el-form-item :label="$t('form.layerDeep')+':'" required>
              ...
              <el-form-item :label="$t('form.sort')+':'" required>
