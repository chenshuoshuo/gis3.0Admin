    ...
    <div class="app-container info-organization">
        <div class="filter-container">
            <el-form ref="form" label-position="left"  :inline="true">
                ...
                <router-link :to="{path:'/information-manager/createOrganization',query:{method:'add',total:total}}">
        ...
        <el-table :data="list" v-loading="listLoading" element-loading-text="加载中..." border fit
          ...
          <import-dialog uploadUrl="/mapOrganization/upload" :update="getList" ref="upload"/>
    </div>
</template>
