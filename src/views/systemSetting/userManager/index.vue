<template>
  <div class="app-container user-manager">
    <div class="filter-container">
        <el-form ref="form" label-position="left"  :inline="true">
            ...
            <el-form-item label="手机号码:">
                <el-input class="filter-item" placeholder="请输入" v-model="listQuery.phone">
                </el-input>
            </el-form-item>
            <el-button class="filter-item" type="primary" v-waves icon="el-icon-search" @click="handlerSearch">搜索
            </el-button>
            <router-link to="/systemSetting/editUser">
                <el-button class="filter-item" style="margin-left: 10px;" type="success" icon="el-icon-edit">添加
                </el-button>
            </router-link>
            <el-button class="filter-item" style="margin-left: 10px;" type="danger"  @click="handleDeletMany" icon="el-icon-delete" >删除
            </el-button>
        </el-form>
    </div>
    <el-table :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit
      ...
      <el-table-column min-width="150px" label="手机号码" align="center">
        <template slot-scope="scope">
  ...
  export default {
    ...
    data() {
      return {
        ...
        showReviewer: false,
        list:[
            {username:"asdf",phone:"10000000000",role:"admin",update_time:new Date().getTime()},
            {username:"asdf",phone:"10000000000",role:"admin",update_time:new Date().getTime()},
            {username:"asdf",phone:"10000000000",role:"admin",update_time:new Date().getTime()},
            {username:"asdf",phone:"10000000000",role:"admin",update_time:new Date().getTime()},
        ]
