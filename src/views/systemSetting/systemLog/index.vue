<template>
  <div class="app-container system-log">
    <div class="filter-container">
        <el-form ref="form" label-position="left"  :inline="true">
            ...
            <router-link to="/3dTileMannger/upTitle">
                <el-button class="filter-item" style="margin-left: 10px;" type="success" icon="el-icon-upload2">导出
                </el-button>
            </router-link>
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit
      ...
      <el-table-column min-width="150px" label="来源模块" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column width="200px" align="center" label="操作描述">
        <template slot-scope="scope">
          <span>{{scope.row.description}}</span>
        </template>
      </el-table-column>
      <el-table-column width="300px" label="创建时间" align="center">
        <template slot-scope="scope">
  ...
  export default {
    ...
    data() {
      return {
        ...
        showReviewer: false,
        list:[
            {username:"asdf",module:"登录",type:"1",description:"xxxxxxx",create_time:new Date().getTime()},
            {username:"asdf",module:"登录",type:"1",description:"xxxxxxx",create_time:new Date().getTime()},
            {username:"asdf",module:"登录",type:"1",description:"xxxxxxx",create_time:new Date().getTime()},
            {username:"asdf",module:"登录",type:"1",description:"xxxxxxx",create_time:new Date().getTime()},
        ]
